...
- [x] **PILOT-01**: User can start a session from a Brain dump item, a typed one-liner, or as an open "just work" session — three equal paths
...
- [x] **DUMP-02**: User can capture items by voice via on-device platform speech-to-text, with graceful fallback to text when STT is unavailable
...
| FND-02 | Phase 1 - Scaffold & Foundations | Complete |
...
| PILOT-01 | Phase 3 - Co-pilot End-to-End | Complete |
...
| DUMP-02 | Phase 4 - Brain Dump | Complete |
